...
#======================================================================================
#     This is a modified script for heatmap in the SPH article
#======================================================================================
...
#second row - genotype names
#first column - names of trap/habitat
#third and further columns - host species numbers
#======================================================================================
...
input_path = "C:\OneDrive\OneDrive - Uniwersytet Jagielloński\Thaumiel\Processing\Article_SPH_Heatmap_Genotype_Distribution"
file_name = "Heatmap_data.txt"
#======================================================================================
...
#beginRecord(PDF,"C:/Users/Walka/Downloads/Article_heatmap.pdf")
#======================================================================================
...
#def legend_pt(pt_size):
#    circle(xx+(i*sqr_size)-(0.5*diam),yy,pt_size*2)
    ...
    if row == data[0]:
        for i in range(len(row)):
            if i == 0:
                ...
                species_name = row[i]
                n_in_species = row.count(species_name)
                #print(species_name, n_in_species)
                if species_name != row[i-1]:
                    noStroke()
                    fill(palette[current_col])
                    rect(xx+(i*sqr_size)-sqr_size-(0.5*diam),yy, sqr_size * n_in_species,sqr_size)
                    current_col +=1
                    fill(255)
                    textAlign(CENTER)
                    text(species_name,(xx+(i*sqr_size)-sqr_size-(0.5*diam))+(0.5*sqr_size*n_in_species),yy+sqr_size-1)
